...
async def launch_wiz(sprinter,username,password):
...
async def go_to_closest_of(self, entities: List, only_safe: bool = False):
...
async def level_5(client):
        ...
        await asyncio.sleep(3)
        await client.send_key(Keycode.UP_ARROW, 1.9)
        await asyncio.sleep(0.3)
        await client.send_key(Keycode.X, 0.6)
        await go_through_dialog(client)
        await asyncio.sleep(0.3)
        ...
        await client.send_key(Keycode.W, 2)
        await asyncio.sleep(0.3)
        await client.send_key(Keycode.X, 0.7)
